...
namespace Pharmasuit.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public OrderDetailsController(PharmasuitContext context)
        {
            _context = context;
        }
        ...
        {
            var pharmasuitContext = _context.OrderDetails.Include(o => o.Order).Include(o => o.Product);
            return View(await pharmasuitContext.ToListAsync());
        }
